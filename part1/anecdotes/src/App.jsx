...
const App = () => {
  const anecdotes = [
    ...
    'The first 90 percent of the code accounts for the first 10 percent \
    ...
    'Programming without an extremely heavy use of console.log is same \
    as if a doctor would refuse to use x-rays or blood tests when \
    diagnosing patients.',
