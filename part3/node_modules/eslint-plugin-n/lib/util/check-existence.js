...
const exists = require("eslint-plugin-n/lib/util/exists")
const getAllowModules = require("eslint-plugin-n/lib/util/get-allow-modules")
const isTypescript = require("eslint-plugin-n/lib/util/is-typescript")
const mapTypescriptExtension = require("eslint-plugin-n/lib/util/map-typescript-extension")
