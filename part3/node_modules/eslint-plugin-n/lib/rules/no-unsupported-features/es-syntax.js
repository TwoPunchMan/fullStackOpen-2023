...
const { Range } = require("eslint-plugin-n/node_modules/semver")
const rangeSubset = require("eslint-plugin-n/node_modules/semver/ranges/subset")
const getConfiguredNodeVersion = require("eslint-plugin-n/lib/util/get-configured-node-version")
const getSemverRange = require("eslint-plugin-n/lib/util/get-semver-range")
const mergeVisitorsInPlace = require("eslint-plugin-n/lib/util/merge-visitors-in-place")
